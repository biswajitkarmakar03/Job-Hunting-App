...
const JobVacancySection = () => {
  const jobs = [
    ...
    },
    {
      ...
      description: "Manage CI/CD pipelines, infrastructure, and deployment workflows.",
      skills: ["AWS", "Docker", "Kubernetes", "Terraform", "Linux"],
    },
    {
      title: "Mobile App Developer",
      description: "Build cross-platform apps with Flutter or React Native.",
      skills: ["Flutter", "React Native", "Dart", "Android/iOS", "API Integration"],
    },
  ];
        ...
        >
          {jobs.map((job, index) => (
            <SwiperSlide key={index}>
              <div className="bg-white border rounded-2xl hover: transition-shadow p-6 text-left border-t-4 border-indigo-600 h-full flex flex-col justify-between">
                <div>
