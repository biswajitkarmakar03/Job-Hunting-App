const Hero = () => {
  return (
    <section className="relative bg-white h-screen pt-24 pb-32 overflow-hidden">
      {/* Gradient Blobs */}
      ...
      {/* Main Content */}
      <div className="relative z-10 pt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <h1 className="text-4xl sm:text-4xl md:text-5xl font-extrabold text-black uppercase animate-fade-in-up">
        ...
        <div className="mt-10 w-full max-w-xl animate-fade-in-up delay-300">
          <div className="flex bg-white shadow-lg rounded-full overflow-hidden border border-indigo-600 focus-within:ring-2 focus-within:ring-indigo-300">
            <input
              type="text"
              placeholder="Search for jobs, roles, or companies..."
              className="w-full px-6 py-3 text-lg text-gray-700 focus:outline-none"
            />
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 transition-colors">
              Search
            </button>
          </div>
        </div>
